...
void main() {
  ...
  // test 1: Defaults
  test('Defaults', () {
    expect(slugify1.slugify('This is a test'), equals('this-is-a-test'));
  });

  // test 2: Delimiter
  test('Custom delimiter', () {
    expect(slugify2.slugify('Per Cent'), equals('per%cent'));
  });

  // test 3: Uppercase
  test('Uppercase', () {
    expect(slugify3.slugify('CAPS LOCK IS CRUISE CONTROL FOR COOL'),
